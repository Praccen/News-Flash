...
export default class GameMachine extends StateMachine {
    ...
    constructor() {
        ...
        this.addState(StatesEnum.CONTROLS, ControlsMenu, 1.0/60.0, new ControlsMenu(this.stateAccessible));
        ...
        // game.load();
        this.addState(StatesEnum.DEBUGMODE, DebugMode, 1.0/144.0, new DebugMode(this.stateAccessible, game));
