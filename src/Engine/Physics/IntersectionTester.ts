...
export module IntersectionTester {
     ...
     * @returns If there is an intersection.
     */
    export function identifyMeshVsMeshWithInformation(meshA: Array<Triangle3D>, meshB: Array<Triangle3D>, intersectionInformation: Array<IntersectionInformation>): boolean { 
            ...
            for (let triangleB of meshB) {
                if (SAT.getIntersection3D(triangleA, triangleB, tempIntersectionAxis, tempIntersectionDepth)) {
                    ...
                    intersectionInformation.push(
                        new IntersectionInformation(tempIntersectionAxis, tempIntersectionDepth.depth, 
                            SAT.getIntersectionPoint(triangleA, triangleB, tempIntersectionAxis)));
                }
            }
        }
