...
export default class ShaderProgram {
    ...
    constructor(gl: WebGL2RenderingContext, shaderProgramName: string, vertexShaderName: string, fragmentShaderName: string, debugShaderCompilation: boolean = false) {
        this.gl = gl;
    ...
    loadShaders(shaderProgramName: string, vertexShaderString: string, fragmentShaderString: string, debugShaderCompilation: boolean) {
        // link shaders
